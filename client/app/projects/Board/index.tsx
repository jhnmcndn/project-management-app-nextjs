      ...
      <div className='mb-3 flex w-full'>
        ...
        <div className='dark:bg-dark-secondary flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4'>
          <h3 className='flex items-center text-lg font-semibold dark:text-white'>
            {status}{' '}
            <span
              className='dark:bg-dark-tertiary ml-2 inline-block rounded-[50%] bg-gray-200 p-1 text-center text-sm leading-none dark:text-white'
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://pm-s3-images-mac.s3.ap-southeast-1.amazonaws.com/${task.attachments[0].fileURL}`}
      ...
      <div className='p-4 md:p-6'>
        ...
        <p className='text-sm text-gray-600 dark:accent-neutral-500'>{task.description}</p>
          ...
          <div className='flex -space-x-[6px] overflow-hidden'>
            {task.assignee && (
              <Image
                ...
                src={`https://pm-s3-images-mac.s3.ap-southeast-1.amazonaws.com/${task.assignee.profilePictureUrl}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-s3-images-mac.s3.ap-southeast-1.amazonaws.com/${task.author.profilePictureUrl}`}
