...
const ModalNewTask = ({ isOpen, onClose, id = null }: Props) => {
  ...
  const selectStyles =
    'mb-4 block w-full rounded border border-gray-300 px-3 py-2 dark:border-dark-tertiary' +
    'dark:text-white dark:focus:outline-none';

  const inputStyles =
    'w-full rounded border border-gray-300 p-2 shadow-sm dark:border-dark-tertiary ' +
    'dark:bg-dark-tertiary dark:text-white dark:focus:outline-none';
      ...
      >
        ...
        <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-2'>
          ...
          >
            ...
            <option value={Priority.High}>Highs</option>
